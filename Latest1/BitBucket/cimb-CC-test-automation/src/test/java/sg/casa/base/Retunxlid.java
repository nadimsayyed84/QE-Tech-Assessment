...
//General
	...
	//CrossSell id	
				...
				int BeforeYouSubmit_Submitxlid = 0;
				int BeforeYouSubmit_ReferredByFriendxlid = 1;
				int BeforeYouSubmit_ReferredByFriend_ApplicantNamexlid = 2;
				int BeforeYouSubmit_ReferredByFriend_NRICPassportNumberxlid = 3;
				int BeforeYouSubmit_DoYouHavePromoCodexlid = 4;
				int BeforeYouSubmit_DoYouHavePromoCode_PromoCodexlid = 5;

				
				//Processing Page - Arpit
				int ProcessingPage_Mappingxlid = 0;
				int ProcessingPage_HowDidYouHearAboutUsxlid = 1;
				int ProcessingPage_SubmitFeedbackxlid = 7;
				
				//Thank You Page - Arpit
				int ThankYouPage_Mappingxlid = 0;				
}
