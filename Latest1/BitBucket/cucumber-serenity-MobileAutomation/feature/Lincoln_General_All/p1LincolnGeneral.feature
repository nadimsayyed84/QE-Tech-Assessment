...
#	Given Open Chrome browser on Lincoln
#	When Maximize browser and enter link "https://wwwENVT.brandap.ford.com/content/lincoln/sk/ko_sk/home/vehicle/continental/compare-models.html" on P1 Lincoln
#	Then See all components on Model Compare page
#	|Continental 3.0L Presidential|Continental 3.0L Reserve + Luxury Pack|Continental 2.7L Reserve + Luxury Pack|Continental 2.7L Reserve|
#	When Click any model image to trigger comparator
#	|Continental 3.0L Presidential|
...
Scenario: P1 Mini LAD Search
	...
	Then See the first result on Map on P1 Lincoln
	|1|
	And Click on Dealer information link on P1 Lincoln
	And Verify Delear details on Map
...
#Scenario: Compare Model EN Scenario_2 - Model Compare in INT environment
#	Given Open Chrome browser on Lincoln
#	When Maximize browser and enter link "https://wwwperf.brandap.ford.com/content/lincoln/sk/ko_sk/home/vehicle/continental/compare-models.html" on P1 Lincoln
#	Then See all components on Model Compare page
#	|Continental 3.0L Presidential|Continental 3.0L Reserve + Luxury Pack|Continental 2.7L Reserve + Luxury Pack|Continental 2.7L Reserve|
#	When Click on Active Compare on P1 Lincoln
#	When Select up to 2 items on the list on P1 Lincoln
...
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home/vehicle/suvs-mkc/specs-and-compare.html" on P1 Lincoln
#		Then See all components on Model Compare page on P1 Lincoln
#		When Click on Active Compare on P1 Lincoln
#		Then See all checkboxes of compare models on P1 Lincoln
...
#		Then See Test Drive form on P1 Lincoln
#		When Fill in Test Drive Form on P1 Lincoln
#		|	先生 |	Son	|	Dang	|	sondn@smartosc.com | 13312345678 | 北京 | 北京 | 北京福瑞林肯中心 | 林肯MKZ | 3个月内 | ABCDE |
#		Then See Thank you overlay on P1 Lincoln
...
## COMPLETED
#Scenario: Key Page Function Check - MKZ Overview Gallery in INT environment
#		Given Open Chrome browser on Lincoln
...
### COMPLETED
#Scenario: Key Page Function Check - LAD Search in INT environment
#		Given Open Chrome browser on Lincoln
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home/locate-dealer.html" on P1 Lincoln
#		Then See all components on LAD page on P1 Lincoln
#		When Click on Select province on LAD page on P1 Lincoln
...
## COMPLETED
#Scenario: Key Page Function Check - Request a brochure in INT environment
#		Given Open Chrome browser on Lincoln
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home.html" on P1 Lincoln
#		Then See all components on home page loaded without performance issue on P1 Lincoln
#		When Click on Request a brochure at the footer on P1 Lincoln
...
#		| 请选择称呼	| 姓名 | 电子邮箱 | 手机号码 | 省 | 市 | 地址 | 邮编 | 请选择偏好林肯车系 | 何时计划购买 | 您是否愿意被经销商联系 | 您是否愿意被经销商联系 | title | state | nameplate | mktPurchaseTime | lastName | firstName | email | mobile | addressLine1 | postcode | captchaValue |
#		When Fill in Request a brochure on P1 Lincoln 
#		| 先生 | Son | Dang | sondn@smartosc.com | 1221234567890 | 上海 | 上海 | DenLu | 12345 | 林肯MKX | 3个月内 | ABCDF |
#		Then See Thank you overlay on P1 Lincoln   



## COMPLETED
#Scenario: Key Page Function Check - MKC Gallery in INT environment
#		Given Open Chrome browser on Lincoln
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/en_cn/home/vehicle/suvs-mkc/gallery.html" on P1 Lincoln
#		Then See all components on MKC Gallery page in P1 INT Lincoln
#		| EXTERIOR | INTERIOR | VIDEOS | image01 | image02 | image03 | image04 | image05 | image06 | image08 | interior1 | interior 2 | interior 3 | interior 4 | interior 5 | interior 6 | interior 7 |
#		When Click on any image on Exterior section in P1 INT Lincoln
#		| image01 |
...
## COMPLETED
#Scenario: Key Page Function Check - Press Release in INT environment
#		Given Open Chrome browser on Lincoln
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home/about/press-release.html" on P1 Lincoln
#		Then See all components on Press Release page on P1 Lincoln
#		When Click on Select Article on Press Release page on P1 Lincoln
#		And Select Year on Select Article dropdown list on P1 Lincoln
#		|	2017 |
#		Then See all articles in this year on Press Release page on P1 Lincoln
#		| 2017 | “林肯之道”通达常熟，带来个性化豪华驾乘体验 | 北京第三家林肯中心开幕，满足消费者日益增长的个性化豪华需求 | 新款林肯MKZ H混合动力正式上市，高效动力激发无限可能 | 新款林肯MKZ H混合动力与全新林肯Navigator概念车亮相2017上海车展，以“静谧的豪华”定 | /content/lincoln/cn/zh_cn/home/about/press-release/article-2017-04-28.html | /content/lincoln/cn/zh_cn/home/about/press-release/article-2017-04-28-a.html | /content/lincoln/cn/zh_cn/home/about/press-release/article-2017-04-19-a.html | /content/lincoln/cn/zh_cn/home/about/press-release/article-2017-04-19.html |
#		When Click an article on Press Release page on P1 Lincoln
#		| “林肯之道”通达常熟，带来个性化豪华驾乘体验 |
#		Then See page redirected to correct link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home/about/press-release/article-2017-04-28.html" on P1 Lincoln
#		And See all components on Article page loaded without performance issue on P1 Lincoln
#		| “林肯之道”通达常熟，带来个性化豪华驾乘体验 | 2017/04/28 | /content/dam/lincoln/cn/l_cn_zh/homepage/experience-lincoln/press-release/1249260216829.jpeg |
#		When Click on Share button on Press Release page on P1 Lincoln
#		Then See all components on Share overlay on Press Release page on P1 INT Lincoln
#		When Click on Close button on Share overlay on P1 Lincoln 
...
#		Then See page redirected to correct link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home/about/press-release.html" on P1 Lincoln
...
## COMPLETED
#Scenario: Key Page Function Check - Model Compare Continential 
#		Given Open Chrome browser on Lincoln
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home.html/content/lincoln/sk/ko_sk/home/vehicle/continental.html" on P1 Lincoln
#		Then See all components on home page loaded without performance issue on P1 Lincoln
...
## COMPLETED
#Scenario: Key Page Function Check - Compare Three Models		
#		Given Open Chrome browser on Lincoln
#		When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/lincoln/cn/zh_cn/home/vehicle/cars-mkz.html" on P1 Lincoln
#		Then See all components on home page loaded without performance issue on P1 INT Lincoln
#		When Click on Compare Model on P1 INT Lincoln
