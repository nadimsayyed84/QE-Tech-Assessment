...
//		Serenity.takeScreenshot();
	...
	public void clickOnActiveCompare() throws Throwable {
		...
		// Compare')]").click();
		getVisibleElementByXpath("//a[contains(text(),' 配置对比') or contains(text(),'Active Compare')  or contains(text(),'비교 모델 선택')]").click();
		Thread.sleep(3000);
//		Serenity.takeScreenshot();
	}
	...
	public void clickOnSelection2Items() throws Throwable {
		...
		List<WebElement> selveh=driver.findElements(By.xpath("//div[1]/h3/label/span[1]"));
		for(int i=1;i<=2;i++) {
			selveh.get(i-1).click();
		}
...
//			getVisibleElementByXpath("//div["+i+"]/h3/label/span[1]").click();
	...
	public void seeAllComponentsAreSelectedToCompare(int numberOfItems) throws Throwable {
		...
		driver.manage().timeouts().implicitlyWait(90, TimeUnit.SECONDS);
		List<WebElement> elements = driver.findElements(By.xpath("//*[contains(@class,'modal-compare-info')]//*[contains(text(),'MKC ') or contains(text(),'MKX ')]"));
		int count = 0;
		for (WebElement element : elements) {
			if (element.isDisplayed()) {
				count++;
	...
	public void selectModelOfThirdVehicleOnModelCompare(DataTable parameter) throws Throwable {
		...
		List<List<String>> data = parameter.raw();
		getVisibleElementByXpath("//a[contains(@class,'cancel-car-selection')]").click();
		Thread.sleep(3000);
		getVisibleElementByXpath("//select[@name='first-primary-model']").click();
		Thread.sleep(3000);
		getVisibleElementByXpath("//option[contains(text(),'" + data.get(0).get(0) + "')]").click();
		Thread.sleep(3000);
		getVisibleElementByXpath("//select[@name='first-second-model']").click();
		Thread.sleep(3000);
	...
	public void seeAllComponentsOnModelCompagePage() throws Throwable {
		...
		getVisibleElementByXpath("//a[contains(text(),' 配置对比')]");//div[contains(@class,'hidden-xs')]/a[contains(text(),' 配置对比')]
...
//		getVisibleElementByXpath("//span[text()='曜岩黑']");
	...
	public void Appropriate_validation_message_displayed(DataTable position) throws Throwable {
		System.out.println("Appropriate validation message displayed");
		Thread.sleep(2000);
		getVisibleElementByXpath("//div[contains(@ng-show,'displayError') and not(contains(@class,'hide'))]");
	}
}
