...
////       driver.manage().timeouts().setScriptTimeout(240, TimeUnit.SECONDS);
	...
	public void click_on_Start_Application_Button() throws Throwable {
		getVisibleElementByXpath("//button[@class='btn-primary']").click();
	    // Write code here that turns the phrase above into concrete actions
		System.out.print("user click on Button");
		Thread.sleep(10000);
