...
public class StarSaver_i_Saving extends BaseTest {
	...
	public void user_Execute_Without_CrossSell_Testcases() throws Throwable {
		...
		for (int i = 3; i <= rowCount; i++) {
			...
			String TestcaseStatus = row.getCell(Star_Saver_i_saving_Retunxlid.Testcase_StatusExcelId).getStringCellValue();
			if (TestcaseStatus.equalsIgnoreCase("Run")) {
				try {
					System.out.println("********************* Product :  Star Saver i (saving) ********************* ");
					System.out.println("++++++++++++++++++++++++++++++++++++++Test Case Execution Excel Row ID : " + i + " Test Case Status : " + TestcaseStatus + " +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ ");

					driver.get(IbaseUrl.StarSaver_i_saving);
					Thread.sleep(5000);

					// Getting Started Page
					String Title_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_Title_xlid).getStringCellValue();
					String FullName_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_FullName_xlid).getStringCellValue();
					String SingaporePR_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_SingaporePR_xlid).getStringCellValue();
					String Nationality_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_Nationality_xlid).getStringCellValue();
					String NRICandPassportNumber_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_NRICANDPassportNUmber_xlid).getStringCellValue();
					String PassportExpiryDate_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_PassportExpiryDate_xlid).getStringCellValue();
					String DateOfBirth_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_DateOfBirth_xlid).getStringCellValue();
					String Email_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_Email_xlid).getStringCellValue();
					double mobilel_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_MobileNumber_xlid).getNumericCellValue();
					String strMobileNumber = Double.toString(mobilel_xlValue);
					String termsandCondition_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_TermsandCondition_xlid).getStringCellValue();
					String gettingstartedBtn_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.GS_StartButton_xlid).getStringCellValue();

					// Account Information Page.
					String AccountType_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.ACI_AccountType_xlid).getStringCellValue();
					String PurposeOfAccount_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.ACI_PurposeOfAccount_xlid).getStringCellValue();
					String SourceOfFundsForInitialDeposit_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.ACI_SourceOfFundsForInitalDeposit_xlid).getStringCellValue();
					String EStatment_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.ACI_EStatment_xlid).getStringCellValue();
					String AccountInformation_IsUserApplyForCrossSellXL = row.getCell(Star_Saver_i_saving_Retunxlid.AccountInformation_IsUserApplyForCrossSell).getStringCellValue();
					String AccountInformation_CrosssellproductTypeXL = row.getCell(Star_Saver_i_saving_Retunxlid.AccountInformation_CrosssellproductType).getStringCellValue();
					String AccountInformation_Crosssel_CrossReferenceIDXL = row.getCell(Star_Saver_i_saving_Retunxlid.AccountInformation_Crosssel_CrossReferenceID).getStringCellValue();
					String Applicationinfobtn_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.ACI_ApplicationinfoBtn_xlid).getStringCellValue();

					// Application Information - Individual - Personal Information
					String APInfo_Indi_Prin_AliasName_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_AliasName_xlid).getStringCellValue();
					String APInfo_Indi_Prin_PrimaryId_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_PrimaryId_xlid).getStringCellValue();
					String APInfo_Indi_Prin_CountryOfBirth_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_CountryOfBirth_xlid).getStringCellValue();
					String APInfo_Indi_Prin_PlaceOfBirth_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_PlaceOfBirth_xlid).getStringCellValue();
					String APInfo_Indi_Prin_Gender_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_Gender_xlid).getStringCellValue();
					String APInfo_Indi_Prin_MaritalStatus_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_MaritalStatus_xlid).getStringCellValue();
					String APInfo_Indi_Prin_Race_xlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_Race_xlid).getStringCellValue();
					String APInfo_Indi_Prin_PrimarySourceOfWelth_xlValue = row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_PrimarySourceOfWelth_xlid).getStringCellValue();
					// Individual - Contact Information
					String APInfo_Indi_Prin_ContactInfo_SecondaryContact_PhoneNumber_xl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.APInfo_Indi_Prin_ContactInfo_SecondaryContact_PhoneNumber_xlid).getNumericCellValue());
					// Individual - Address Information - Residential Address
					String ApplicationInformation_Principal_AddressInformation_ResidentialAddresTypexlvalue = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResidentialAddresTypexlid).getStringCellValue();
					// Local Address
					String AccountInformation_Principal_AddressInformation_ResiAddress_Local_PostalCodexl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Local_PostalCodexlid).getNumericCellValue());
					String AccountInformation_Principal_AddressInformation_ResiAddress_Local_BlockHouseNoxl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Local_BlockHouseNoxlid).getNumericCellValue());
					String AccountInformation_Principal_AddressInformation_ResiAddress_Local_Streetnamexl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Local_Streetnamexlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_ResiAddress_Local_Storyxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Local_Storyxlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_ResiAddress_Local_UnitNumberxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Local_UnitNumberxlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_ResiAddress_Local_BuildingNamexl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Local_BuildingNamexlid).getStringCellValue();
					// Foreign Address
					String AccountInformation_Principal_AddressInformation_ResiAddress_Foreign_Countryxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Foreign_Countryxlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_ResiAddress_Foreign_AddressLine1xl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Foreign_AddressLine1xlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_ResiAddress_Foreign_AddressLine2xl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Foreign_AddressLine2xlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_ResiAddress_Foreign_Postalcodexl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_ResiAddress_Foreign_Postalcodexlid).getNumericCellValue());
					// Individual - Address Information - Mailing Address
					String ApplicationInformation_Principal_AddressInformation_MailingAddresTypexlxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddresTypexlid).getStringCellValue();
					String AccountInformation_Principal_AddressInformation_MailingAddresType_Sameasresidentialaddress_No = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_isResidentialid).getStringCellValue();

					// Local Address
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_PostalCodexlidxl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_PostalCodexlid).getNumericCellValue());
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_IsuserClickOnGetAddressButtonxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_IsuserClickOnGetAddressButton).getStringCellValue();
					// String
					...
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_BlockHouseNoxlidxl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_BlockHouseNoxlid).getNumericCellValue());
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_Streetnamexlidxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_Streetnamexlid).getStringCellValue();
					String ApplicationInformation_Principal_AddressInformation_MailingAddress_Local_Storyxlidxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddress_Local_Storyxlid).getStringCellValue();
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_UnitNumberxlidxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_UnitNumberxlid).getStringCellValue();
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_BuildingNamexlidxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Local_BuildingNamexlid).getStringCellValue();

					// Foreign Address
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_Countryxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_Countryxlid).getStringCellValue();
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_AddressLine1xl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_AddressLine1xlid).getStringCellValue();
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_AddressLine2xl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_AddressLine2xlid).getStringCellValue();
					String ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_Postalcodexl = CommonMethords.GetNumbersConvertToStringValue(row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AddressInformation_MailingAddres_Foreign_Postalcodexlid).getNumericCellValue());

					// JOB Information Section.
					String ApplicationInformation_Principal_JobInformation_EmploymentStatusxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_JobInformation_EmploymentStatusxlid).getStringCellValue();
					String ApplicationInformation_Principal_JobInformation_Occupationxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_JobInformation_Occupationxlid).getStringCellValue();
					String ApplicationInformation_Principal_JobInformation_NameOfCompanyxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_JobInformation_NameOfCompanyxlid).getStringCellValue();
					String ApplicationInformation_Principal_JobInformation_NatureOfbusinessxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_JobInformation_NatureOfbusinessxlid).getStringCellValue();

					// Account Preferences Section.
					String ApplicationInformation_Principal_AccountPreferences_DoYouNeedaATMCardxl = row.getCell(Star_Saver_i_saving_Retunxlid.ApplicationInformation_Principal_AccountPreferences_DoYouNeedaATMCardxlid).getStringCellValue();
					...
					if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Credit Card Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
						...
						StarSaver_i_Saving_WithCrossSellCreditCard.ExecuteCrossSellCreditcard(AccountInformation_Crosssel_CrossReferenceIDXL, "Personal Information", driver);
					}
					...
					if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Credit Card Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
						System.out.println("For your Credit Card Application");
						StarSaver_i_Saving_WithCrossSellCreditCard.ExecuteCrossSellCreditcard(AccountInformation_Crosssel_CrossReferenceIDXL, "Contact Information", driver);
					}
					...
					if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Credit Card Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
						System.out.println("For your Credit Card Application");
						StarSaver_i_Saving_WithCrossSellCreditCard.ExecuteCrossSellCreditcard(AccountInformation_Crosssel_CrossReferenceIDXL, "Address Information", driver);
					}
					...
					if (ApplicationInformation_Principal_JobInformation_EmploymentStatusxl.contentEquals("Employed") || ApplicationInformation_Principal_JobInformation_EmploymentStatusxl.contentEquals("Self-employed") || ApplicationInformation_Principal_JobInformation_EmploymentStatusxl.contentEquals("Commission")) {
						...
						if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Credit Card Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
							System.out.println("For your Credit Card Application");
							StarSaver_i_Saving_WithCrossSellCreditCard.ExecuteCrossSellCreditcard(AccountInformation_Crosssel_CrossReferenceIDXL, "Job Information", driver);
						}
					}
					// Account Preferences Section.
					...
					if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Credit Card Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
						...
						Thread.sleep(3000);
						StarSaver_i_Saving_WithCrossSellCreditCard.ExecuteCrossSellCreditcard(AccountInformation_Crosssel_CrossReferenceIDXL, "Credit Card", driver);
					}
					...
					if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Credit Card Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
						...
						Thread.sleep(3000);
						StarSaver_i_Saving_WithCrossSellCreditCard.ExecuteCrossSellCreditcard(AccountInformation_Crosssel_CrossReferenceIDXL, "Supplementary Card", driver);
					}
					...
					if (AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("Fixed Deposit Only") || AccountInformation_IsUserApplyForCrossSellXL.equalsIgnoreCase("FD + Credit card")) {
						if (AccountInformation_CrosssellproductTypeXL.equalsIgnoreCase("Fixed Deposit")) {
							...
							Thread.sleep(3000);
							StarSaver_i_Saving_FixedDeposit.ExecuteFixedDeposit(AccountInformation_Crosssel_CrossReferenceIDXL, driver);
						}
					}
					...
					if (AccountType_xlValue.equalsIgnoreCase("joint")) {
						...
						StarSaver_i_Saving_Joint.ExecuteJointAccount(row.getCell(17).getStringCellValue(), driver);
					}
					Thread.sleep(5000);
