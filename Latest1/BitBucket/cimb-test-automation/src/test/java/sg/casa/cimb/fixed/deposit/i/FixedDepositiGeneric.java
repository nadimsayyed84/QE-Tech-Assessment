...
public class FixedDepositiGeneric {
	...
	public static void ExecuteFixedDeposit(String FixeddepsitId, WebDriver driver) throws InterruptedException, IOException {
	  ...
	  int rowCount = guru99Sheet.getLastRowNum()-guru99Sheet.getFirstRowNum();
		...
		if(xlAccountTypeID.equalsIgnoreCase(FixeddepsitId)) {
			...
			CommonMethords.SelectDropdown(FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit, ApplicationInformation_CrossSell_FixedDeposit_ModeofDepositXL,driver);
			...
			if(ApplicationInformation_CrossSell_FixedDeposit_ModeofDepositXL.equalsIgnoreCase("Debit my existing CIMB Bank a/c")) {
				driver.findElement(org.openqa.selenium.By.xpath((FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_AccountNumber))).sendKeys("1234567890");
				driver.findElement(org.openqa.selenium.By.xpath((FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_AccountNumber_GetOTPBtn))).click();
				Thread.sleep(3000);
				driver.findElement(org.openqa.selenium.By.xpath((FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_AccountNumber_VerifyOTPText))).sendKeys("123456");
				driver.findElement(org.openqa.selenium.By.xpath((FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_AccountNumber_VerifyOTPBtn))).click();
			}
			
		 //Select Currancy
			CommonMethords.SelectDropdown(FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_Currency, ApplicationInformation_CrossSell_FixedDeposit_CurrencyXL,driver);
			System.out.println("Currancy : " + ApplicationInformation_CrossSell_FixedDeposit_CurrencyXL);	

	    //Select Tenue
			CommonMethords.SelectDropdown(FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_Tenure, ApplicationInformation_CrossSell_FixedDeposit_TenureXL,driver);
			System.out.println("Tenue : " + ApplicationInformation_CrossSell_FixedDeposit_TenureXL);		
			
		    //Enter Deposit Ammount
			driver.findElement(org.openqa.selenium.By.xpath((FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_DepositAmount))).sendKeys("100000");
			System.out.println("Deposit Ammount : 100000");		
			
		    //Select Maturity Renewal Instruction
				CommonMethords.SelectDropdown(FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_MaturityRenewalInstruction, ApplicationInformation_CrossSell_FixedDeposit_MaturityRenewalInstructionXL,driver);
				...
				if(!ApplicationInformation_CrossSell_FixedDeposit_MaturityRenewalInstructionXL.equalsIgnoreCase("Principal + Interest")) {
					//Select Maturity Renewal Instruction
					CommonMethords.SelectDropdown(FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_InstructionsForAnyPayment, ApplicationInformation_CrossSell_FixedDeposit_InstructionsForAnyPaymentXL,driver);
					...
					if(ApplicationInformation_CrossSell_FixedDeposit_InstructionsForAnyPaymentXL.equalsIgnoreCase("Credit my existing CIMB Bank a/c")) {
						...
						driver.findElement(org.openqa.selenium.By.xpath((FixedDepositi_Elements.AccountInfromation_CrossSell_FixedDeposit_ModeOfDeposit_CIMBAccountNumberToCredit))).sendKeys("1234567890");
					}
				}
