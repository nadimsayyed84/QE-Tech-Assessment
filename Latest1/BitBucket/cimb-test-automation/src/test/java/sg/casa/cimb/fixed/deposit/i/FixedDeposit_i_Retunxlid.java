...
public interface FixedDeposit_i_Retunxlid {
//General
	...
	//CrossSell id	
			...
			//Your Decleration Page	- Main Page - Individual Sheet
				int YourDecleration_IshavingSupplimentryCard = 75;
				int YourDecleration_CrossReferenceID = 76;
				
				//Your Decleration Page	- Decleration Sheet
				int YourDecleration_childID = 0;
				int Principal_PDPA_VoiceandPhoneCall = 2;
				int Principal_PDPA_SMSansMMS =3;
				int Principal_AreYou_UnitedStatesOr_territories = 4;
				
				int Principal_USResident = 5;
				int Principal_USCitizen = 6;
				int Principal_USPermanent = 7;
					
				//Joint
				int Joint_PDPA_VoiceandPhoneCall = 17;
				int Joint_PDPA_SMSansMMS =18;
				int Joint_AreYou_UnitedStatesOr_territories = 19;
				
				int Joint_USResident = 20;
				int Joint_USCitizen = 21;
				int Joint_USPermanent = 22;
}
