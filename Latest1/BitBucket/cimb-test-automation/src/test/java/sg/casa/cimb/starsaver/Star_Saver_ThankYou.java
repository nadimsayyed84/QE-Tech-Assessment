...
public class Star_Saver_ThankYou extends BaseTest{
					  ...
					  int rowCount = guru99Sheet.getLastRowNum()-guru99Sheet.getFirstRowNum();
					    ...
					    for (int i = 3; i <= rowCount; i++) {
							...
							if(ThankYouPageIDXL.equalsIgnoreCase(ParentMappingID)) {
								...
								WebElement element = (new WebDriverWait(driver, 120)).until(ExpectedConditions.elementToBeClickable(By.xpath(SG_CASA_UI_Elements.ThankYouPage_DownloadApplication)));
								//Time Calculation
