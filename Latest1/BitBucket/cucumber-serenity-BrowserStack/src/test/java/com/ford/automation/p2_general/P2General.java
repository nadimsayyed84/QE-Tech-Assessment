...
//			}
	...
	public void clickOnDeleteVehicle() throws Throwable {
		...
		getVisibleElementByXpath("//div[@class='tabs-content ownerVehicleContent active']//a[contains(@class, 'link-delete-vehicle-overlay') and text()='Delete Vehicle' or text()='删除车辆']").click();
	}
	...
	public void clickOnConfirmToDeleteVehicle() throws Throwable {
		System.out.println("Click on Confirm to Delete Vehicle");
		Thread.sleep(2000);
		waitTillElementExist("//div[@class='tabs-content ownerVehicleContent active']//a[@class='delete-vehicle-confirm']");
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("div.tabs-content.ownerVehicleContent.active a.delete-vehicle-confirm")).click();
	...
	public void see_delete_vehicle_confirmation_overlay() throws Throwable {
		System.out.println("See delete vehicle confirmation overlay");
		waitTillElementExist("//div[@class='tabs-content ownerVehicleContent active']//a[@class='delete-vehicle-confirm' and contains(text(), 'Yes, I am sure') or contains(text(),'是的，我确定')]");
		getVisibleElementByXpath("//div[@class='tabs-content ownerVehicleContent active']//a[contains(@class,'delete-vehicle-cancel') and contains(text(), 'Cancel') or contains(text(),'取消')]");
		getVisibleElementByXpath("//div[@class='tabs-content ownerVehicleContent active']//a[@class='delete-vehicle-confirm' and contains(text(), 'Yes, I am sure') or contains(text(),'是的，我确定')]");
	}
...
//		getVisibleElementByXpath("//div[@class='heading']//div[@class='price notranslate']//span[text()='" + data.get(0).get(5) + "']");
	...
	public void seeDriveList() throws Throwable {
		...
		getVisibleElementByXpathNoMovement("//span[contains(text(),'1.5L Ti-VCT DOHC Petrol/5-speed Manual Transmission')]");
	}
	...
	public void seeTheNamesAreSortedInt() throws Throwable {
		...
		getVisibleElementByXpath("//*[@id='accessories']//li[@class='ng-scope active']//span[contains(text(),'Alloy wheel lock nut set')]");
		getVisibleElementByXpath("//*[@id='accessories']//li[@class='ng-scope active']//span[contains(text(),'AlloyFiestaAmb_Trend')]");
		getVisibleElementByXpath("//*[@id='accessories']//li[@class='ng-scope active']//span[contains(text(),'Bonnet Protector - clear - EGR')]");
	}
...
////		moveToElement(driver.findElement(By.cssSelector("div[slider]")));//getVisibleElementByXpath("//span[contains(@class,'slider')]");
//		WebElement slider = driver.findElement(By.xpath("//div[@ng-model='ctrl.downPaymentSlider']/span"));//driver.findElement(By.cssSelector("div[slider] span")); //driver.findElement(By.xpath("//div[@ng-model='ctrl.downPaymentSlider']//span"));  
...
//	    getVisibleElementByXpath("//div[@id='model']//label[contains(@class,'checkbox')]//a[contains(@ng-click,'showPricePop')]").click();
//	    waitTillElemVisiblebyXpath("//div[contains(@class,'panel-price') and contains(@class,'active')]//div[contains(text(),'Bs') or contains(text(),'$')]", 10000);
		Thread.sleep(5000);
//		getVisibleElementByXpath("//div[contains(@class,'panel-price') and contains(@class,'active')]");
		
	    String fetchPrice= GetOnlyNumberFromStr(driver.findElements(By.xpath("//div[contains(@class,'panel-price') and contains(@class,'active')]//div[contains(@class,'notranslate') and contains(@class,'dual-txt')]")).get(0).getText().trim(),"-?\\d+") + "~" +
	    GetOnlyNumberFromStr(driver.findElements(By.xpath("//div[contains(@class,'panel-price') and contains(@class,'active')]//div[contains(@class,'notranslate') and contains(@class,'dual-txt')]")).get(1).getText().trim(),"-?\\d+");
...
//		getVisibleElementByXpath("//span[contains(text(),'Series')]/following-sibling::div//span[@id!='']").click();
//		getVisibleElementByXpath("//li/div[text()='"+data.get(0).get(8)+"']").click();
//		getVisibleElementByXpath("//span[contains(text(),'Market Date')]/following-sibling::div//span[@id!='']").click();
//		getVisibleElementByXpath("//li/div[text()='"+data.get(0).get(9)+"']").click();
...
//	public void verify_thank_you_page() throws Throwable {
//	    // Write code here that turns the phrase above into concrete actions
