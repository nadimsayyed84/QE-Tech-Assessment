...
public class BaseTest {
	...
	public static String getHost=null,modelName=null;
	...
	protected static String term=null,tempStr=null;
	protected static int modelPrice=0,downpayment=0,amtfinanced=0,downpaymRatio=0,TempValue=0,paympkg=0,monthlyPay=0;
	static {
		try {
			...
			getHost="https://www"+"int"+"."; 										///Manual Environment Specifier: int/dev/perf/qa
		}	
...
//		return null;
	...
	public void waitTillElemVisible(String str, int timetowait) {
		WebDriverWait wait = new WebDriverWait(driver, timetowait);
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath(str))));
	}
	
	//RnD
	public void WaitTillElementFound(String property,String textToCompare, int timetowait) {
		WebDriverWait wait = new WebDriverWait(driver, timetowait);
		List<WebElement> elements = driver.findElements(By.xpath(property));
		for (WebElement element : elements) {
