...
//		getVisibleElementByXpath("//li[contains(text(),'" + data.get(0).get(1) + "')]").click();
	...
	public void fillInKeepMeInformed(DataTable parameter) throws Throwable {
		...
		// Thread.sleep(2000);
		// Chkbox.get(2).click();
		// getVisibleElementByXpath("//div[4]/div[5]/div/div/div/div/section/div/div/div/div[1]/form/div[2]/div/div/div[6]/button[contains(text(),'
		// 确认提交')]").click();
		getVisibleElementByXpath("//button[contains(text(),'确认提交') and contains(@class,'full')]").click(); // changes propery 14/8 during perf testing - old //button[contains(text(),'
																											// 确认提交')]
	}
	...
	public void clickOnMailtoButtonOnRequestBrochureOverlay() throws Throwable {
		...
		getVisibleElementByXpath("//a[@id='mailForm' and @class='btn btn-large get-entity-form-btn btn-solid bg-gold' and contains(text(),'获取实体手册')]").click();
	}
...
//			modelselect.get(1).click();
	...
	public void clickOnVideoInMkzPage() throws Throwable {
		...
		waitTillElemVisiblebyXpath("span[@id='nameplateKey']/following::div//div//div[@class='billboardCarousel']//div[contains(@class,'billboard-carousel carousel owl-oneitem')]//div[@class='hidden-xs']//span[@class='lincoln-icon_play-thin']", 240);
		//waitTillElemVisiblebyXpath("//div[contains(@class,'billboard-carousel carousel owl-oneitem')]//div[@class='hidden-xs']//a[@class='btn-play text-white text-center']//span[@class='lincoln-icon_play-thin']", 240);
		getVisibleElementByXpath("span[@id='nameplateKey']/following::div//div//div[@class='billboardCarousel']//div[contains(@class,'billboard-carousel carousel owl-oneitem')]//div[@class='hidden-xs']//span[@class='lincoln-icon_play-thin']").click();
		//getVisibleElementByXpath("//div[contains(@class,'billboard-carousel carousel owl-oneitem')]//div[@class='hidden-xs']//a[@class='btn-play text-white text-center']//span[@class='lincoln-icon_play-thin']").click();
...
//		getVisibleElementByXpath("//span[text()='曜岩黑']");
	...
	public void inputTxtAndSearch(DataTable position) throws Throwable {
		...
		//Updated by Arpit
		//two contains condition was not acceptable in case of Microsoft edge.I made one condition with the specific tag also.
		//getVisibleElementByXpath("//*[contains(@class,'locate-a-dealer')]//*[contains(@class,'lincoln-icon_search')]").click();
		getVisibleElementByXpath("//i[contains(@class,'lincoln-icon_search')]").click();	
	}
