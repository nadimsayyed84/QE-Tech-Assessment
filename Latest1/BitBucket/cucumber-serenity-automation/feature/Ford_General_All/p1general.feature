...
Scenario: P1 China Main LAD
	When Redirect to link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/cn1/zh_cn/home/locate-a-dealer.html" on P1
...
|Hatchback 1.5L Sport with EcoBoost|
...
Scenario: P1 Validate Country Selector (MEA)
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/sau/ar_sa/home/country-lang-selector.html"
...
Scenario: P1 Verify Bright Cove functinality when it configured inside a page (Not like a overlay)
	When Redirect to link "https://wwwint.brandap.ford.com/content/ford/in/en_in/home/brightcove.html" on P1 
	And Click on the play Icon
	Then Bright cove should be playing
	When Redirect to link "https://wwwint.brandap.ford.com/content/ford/in/en_in/home/cuv/freestyle.html" on P1
	And Click on the play Icon
