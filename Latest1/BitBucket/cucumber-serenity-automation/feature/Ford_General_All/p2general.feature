...
Scenario: P2 Verify Owner Registration for CHINA 
	...
	And Input email to inbox field 
		|| 
	And Click on Go button 
	When Redirect to link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/cn1/zh_cn/home.html#overlay/content/guxap-uat-demo/cn1/zh_cn/site-wide-content/overlays/form-overlays/login.html?captchaMark=1234&captchaMarkEncrypt=8U8ZdxsyiATvLaJ6eHIq4Q==&notToDB=true" on P2 
	And See the Login overlay on P2 
	And Click on Register link on Login overlay on P2 
	Then See the Register overlay on P2 
...
Scenario: P2 Verify loading page for Owner for CHINA - Login using New User 
	Given Open chrome browser on P2 
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/cn1/zh_cn/home.html#overlay/content/guxap-uat-demo/cn1/zh_cn/site-wide-content/overlays/form-overlays/login.html" on P2 
	And See the Login overlay on P2
	When Enter credentials to login on P2 
		||Test1234567|
	And Click on Login button on P2 
	...
	Then Verify first vehicle tab is loaded correctly on P2 
	When Click on Update New Version link on Profile overlay on P2 
	Then Click on Download Now link on Profile overlay on P2 
...
Scenario: P2 Verify Forgot Username and Forgot Password of Existing Owner for CHINA
	...
	When See forgot overlay opened
	Then Enter email id and Username
	|060318115933@mailinator.com|060318115933|
	When click on Submit button
	Then Successful message displayed
    When Redirect to link "https://www.mailinator.com/v2/inbox.jsp?zone=public&query=REPLACETOUNIQUE" on P2
   	And Click on Forgot username Email on MailInator page
...
Scenario: P2 B&P AU Verify loading landing page on Build and Price
		Given Open chrome browser on P2	
	  	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/au2/en_au/home/build-and-price/billboard.html" on P2
	  	And Click on Build and Price on P2
		When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/au2/en_au/home/build-and-price/build-and-price.html?n=Fiesta_AU&l=2000&u=P" on P2
	  	When Click on Models on P2 INT
	  	And Click on kind of vehicle on P2 INT
	  	|Fiesta Trend|
		Then Verify Drive away price with SL calls
  		|//div[@class='rcol']//span[@class='ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=2000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=P|
		...
		Then Verify Drive away price with SL calls
  		|//div[@class='rcol']//span[@class='ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=123&env=P&location=2000&modelKey=396&optionPrice=885&transmissionFeatureKey=6396&usageType=P|
	  	And Click on Sort by Price on P2 INT
	  	Then See the prices are sorted on P2 INT
	  	And Click on Accessory Price Item on P2 INT
		Then Verify Drive away price with SL calls
  		|//div[@class='rcol']//span[@class='ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=161&env=P&location=2000&modelKey=396&optionPrice=885&transmissionFeatureKey=6396&usageType=P|
	  	When Click on Review & Save button on P2
		Then See Pricing Summary on P2
		Then Verify Drive away price with SL calls
  		|//div[@class='txt-price ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=161&env=P&location=2000&modelKey=396&optionPrice=885&transmissionFeatureKey=6396&usageType=P|
		When Click on Share button on P2
		Then See the sharing popup on P2
		And Verify the Download File on "https://wwwint.brandap.ford.com/content/guxap-uat-demo/au2/en_au/home/build-and-price/build-price-review-save-page.html?l=2000&u=P&n=Fiesta_AU&m=396&d=6396&e=6135&t=6275&y=2013&vc=Passenger_Vehicles&p=25451&ae=6748&ai=&ao=&as=&au=&am=" on P2
...
Scenario: P2 B&P INDIA Vehicle selection,Sort By Price/Fuel/Body Style,Pkg,Color/Trim,Assosseries,Hamburger menu,Change Vehicle,Book a test drive,Review & save,start a new build,Save as PDF,Share,Req a Quote
  Given Open chrome browser on P2
  When Maximize browser and enter link "https://wwwdev.brandap.ford.com/content/guxap-uat-demo/in/en_in/home/build-and-price/billboard.html?captchaMark=1234&captchaMarkEncrypt=8U8ZdxsyiATvLaJ6eHIq4Q==&notToDB=true" on P2
...
##  	|Fiesta Trend|
  	Then Verify Drive away price with SL calls
  	|//div[@class='rcol']//span[@class='ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=4000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=B|
...
##  	|Fiesta Trend|
	...
	And Verify No Cost Option text for zero price
  	|No Cost Option| 	
  	And Verify Drive away price with SL calls
  	|//div[contains(@class,'txt-price')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=4000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=B|
	When Click on Save as PDF link
	Then User is able to download the pdf file 
	And Verify Drive away price with SL calls
  	|//div[contains(@class,'txt-price')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=4000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=B|	
	...
	Then See Pricing Summary on P2 
	And Verify Drive away price with SL calls
  	|//div[contains(@class,'txt-price')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=2000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=P|
  	When Click on Back link in Review & Save page
	Then see User is directing to Build and Price page
	And Verify Drive away price with SL calls
  	|//div[@class='rcol']//span[@class='ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=2000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=P|	
...
Scenario: P2 B&P AU Verify Functionality of Change Postal Code link and Change Vehicle link in B&P configuration page 
	...
	Then see Drive away price
	And Verify Drive away price with SL calls
  	|//div[@class='rcol']//span[@class='ng-binding' and contains(text(),'$')]|https://wwwqa.dfyservices.ford.com/fordowner/vehicle/buildandprice/calcBPDriveAwayPriceForAUS?accessoryPrice=0&env=P&location=2000&modelKey=396&optionPrice=500&transmissionFeatureKey=6396&usageType=B|	
	When Click on Change Vehicle link under vehicle nameplate
	Then Click on YES on confirmation overlay 
	And see user is navigate to vehicle selection page
	And Select a Vehicle
...
@P2
Scenario: P2 B&P Venezuela Verify Sorting the Vehicle based on different Criteria,Navigate to B&P Configuration page
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/ve/es_ve/home/build-and-price/select-a-vehicle.html" on P2
	...
	And Select a Vehicle
 	|Explorer|	
 	When Click on Tabs "model"
 	And Click on the Show Pricing link in each models
 	Then An overlay should show model prices in two different currencies




@P2
Scenario: P2 B&P Venezuela Verify the prices of Color and Trim and Verify Total price of selected model and its color and trim
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/ve/es_ve/home/build-and-price/select-a-vehicle.html" on P2
	Then Select a Vehicle
 	...
 	And Click on ShowPrice "model"
 	Then See the model price in Show Price
 	When Click on Tabs "colorandtrim"
 	And Select any Color
 	And Click on ShowPrice "colorandtrim"
 	Then See the color and trim price in Show Price
 	When Click on the Show Pricing link in beside Review and Save CTA Button
 	Then See the Total price in Show Price




@P2
Scenario: P2 B&P Venezuela Verify Review & Save Page,Verify the PDF and Social Share, Back Button & Change Vehicle link 
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/ve/es_ve/home/build-and-price/select-a-vehicle.html" on P2
	Then Select a Vehicle
 	|Explorer|	
...
@P2
Scenario: P2 B&P Venezuela Verify the Disclosure configuration in Vehicle Configuration and Review and Save page
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/ve/es_ve/home/build-and-price/select-a-vehicle.html" on P2
	Then Select a Vehicle
 	|Explorer|	
 	...
 	And Select any Color
 	And Click on ShowPrice "colorandtrim"
	Then See disclosure id configured
	And corresponding disclosure should be displaying in Disclosure box
	When Click on Review & Save button on P2
	Then See Pricing Summary on P2
	When Click on the Show Pricing link in beside Review and Save CTA Button
	Then See disclosure id configured
...
@P2
Scenario: P2 B&P Venezuela Verify Request A Quote form
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/ve/es_ve/home/build-and-price/select-a-vehicle.html?captchaMark=1234&captchaMarkEncrypt=8U8ZdxsyiATvLaJ6eHIq4Q==&notToDB=true" on P2
	Then Select a Vehicle
 	|Explorer|	
	When Click on Review & Save button on P2
	When Click on the Request a quote Btn
	Then user can make a request of quote after filling all the form details
	|Bà|FirstName|080817174330@mailinator.com|Address|0123456789|
	And Verify thank you page is seen and Close Overlay
...
@P2
Scenario: P2 B&P Venezuela Total price calucation in differnt combinations, Nameplate name is removed from the B&P Pages and Currency Format and rounding of vehicle prices
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/ve/es_ve/home/build-and-price/select-a-vehicle.html" on P2
	Then Select a Vehicle
 	|Explorer|	
 	...
 	When Click on Tabs "colorandtrim"
 	And Select any Color
 	And verify that Nameplate name is removed from the B&P Pages
 	And Click on ShowPrice "colorandtrim"
 	Then See the color and trim price in Show Price
	When Click on Review & Save button on P2
	Then See Pricing Summary on P2
	And See Review and Save page also given accurate total prices
	And verify that Nameplate name is removed from the B&P Pages
	And Check the prices displaying is followed the Currency format and Rounding off option
	|Bs ##.###.###,##|$ ##,###.##|


@P2
Scenario: P2 Verify Credit CHINA Data validation on Payment Estimator page,Sort By features,verify price details,change vehicle model
Given Open chrome browser on P2
...
Scenario: P2 Credit CHINA - Check Summary List
	...
	When Select a China Vehicle
 	...
 	|40000|
 	When Select card
	|Standard APR Programe|EW-Bundled|
...
@CR
Scenario Outline: CRs CN Auto complete City combo box on Test Driver form 
	Given Open chrome browser on P2
	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/cn1/zh_cn/site-wide-content/overlays/forms/test-drive.html?captchaMark=1234&captchaMarkEncrypt=8U8ZdxsyiATvLaJ6eHIq4Q==&notToDB=true" on P2
  	And Enter province "<province>" and some text in the autosearch box for City field "<ValidCity>" 
	Then system should display the cities starting with "<ValidCity>"
	When Enter province "<province>" and some text in the autosearch box for City field "<InvalidCity>" 
	Then No values should be searched and show a validation message
Examples:
	|province|ValidCity|InvalidCity|	
	|湖南	   |湘		 |7InvalidCity|
...
#@P2-test
#Scenario: CRs CN JMC test drive form validation and dropdown list items of dealers 
#	Given Open chrome browser on P2
#	When Maximize browser and enter link "https://wwwint.brandap.ford.com/content/guxap-uat-demo/cn1/zh_cn/site-wide-content/overlays/forms/test-drive.html" on P2
...
##	When Select the Province and city in the form 
##	Then The dropdown list of dealers according to the combination of nameplate, model, province and city
...
#	Then See page redirected to correct link "http://wwwqa.fordtechservice.dealerconnection.com/vdirs/common/auth_error.asp?reason=no_perms" on P2 	
#	And Logout China Owner
#	When Redirect to link "https://wwwint.brandap.ford.com/content/ford/cn/zh_cn/home.html#overlay/content/ford/cn/zh_cn/site-wide-content/overlays/form-overlays/login.html" on P2 
#	And See the Login overlay on P2
#	When Enter credentials to login on P2 
