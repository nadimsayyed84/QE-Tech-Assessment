...
//		}
	...
	public void Clickonotherplaceofthemapapartfromthedealerinfowhitebox() throws Throwable {
		System.out.println("Click on Dealer Details in China Map");
//		getVisibleElementByXpath("//div[contains(@class,'amap-pancontrol')]").click();
...
//		System.out.println(getVisibleElementByXpath("//span[contains(@class,'marker-label')]").getSize().getWidth());
//		new Actions(driver).moveByOffset(getVisibleElementByXpath("//span[contains(@class,'marker-label')]").getSize().getWidth()+50, getVisibleElementByXpath("//div[contains(@class,'amap-pancontrol')]").getSize().getHeight()+50).click().build().perform();
	}
...
//		getVisibleElementByXpath("//div[contains(@class,'accordion-wrap') and not(contains(@class,'opened'))]//div[contains(@class,'accordion-head')]").sendKeys(Keys.ENTER);;
	}
	...
	public void Bright_cove_should_be_playing() throws Throwable {
		...
		getVisibleElementByXpath("//div[contains(@id,'videoplayer')]//div[contains(@class,'video-js') and (not(contains(@class,'vjs-paused')) or not(contains(@class,'vjs-ended')) and contains(@class,'vjs-playing'))]");
		do {
			Thread.sleep(5000);
...
//			getVisibleElementByXpath("//div[contains(@class,'start-image') and not(contains(@style,'none'))]").click();
		}
	}
